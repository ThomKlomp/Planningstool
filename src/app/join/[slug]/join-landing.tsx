    ...
    <main className="flex min-h-screen items-center justify-center bg-paper px-6 py-12">
      <div className="w-full max-w-sm rounded-2xl border border-line bg-white p-8 text-center">
        ...
        <p className="mt-3 text-sm text-ink/60">
          Log in of maak een account aan om als medewerker mee te werken bij{" "}
        ...
        {sent ? (
          <div className="mt-6 rounded-lg bg-awning/10 px-4 py-4 text-left text-sm text-awning">
            ...
            <p className="mt-1 text-awning/90">
              ...
              daarop om je account te activeren, log daarna in en open deze
              link nog een keer om je aan te sluiten.
            </p>
          </div>
        ) : !showEmailForm ? (
          <>
          ...
          <form onSubmit={handleRegister} className="mt-6 space-y-3 text-left">
            ...
            >
              {loading ? "Bezig..." : "Account aanmaken & aansluiten"}
            </button>
